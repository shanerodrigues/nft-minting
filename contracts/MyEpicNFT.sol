...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Doctorate", "Anticipated", "Awkward", "Pretzel", "Dynamic", "Omniscient"];
  string[] secondWords = ["Prairie", "Ridonculous", "Dune", "Preposterous", "Hummock", "Wacky"];
  string[] thirdWords = ["Frenchy", "Staffy", "Boxer", "Poodle", "Shiba Inu", "Husky"];
